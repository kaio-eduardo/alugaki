...
class Imgresize
{
    ...
    private static function resizeImage($file, $max_width, $max_height)
    {
    ...
    public static function convertImage($originalImage, $outputImage, $quality, $larguramaxima, $alturamaxima)
    {
        ...
        if (preg_match('/jpg|jpeg/i', $ext)) {
            ...
            $imageTmp = imagecreatefromwebp($originalImage["tmp_name"]);
        } else {            
            return 0;
        }
        imagejpeg(self::resizeImage($imageTmp, $larguramaxima, $alturamaxima), $outputImage, $quality);
